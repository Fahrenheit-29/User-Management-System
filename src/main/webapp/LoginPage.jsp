...
<body>
	...
	%>
	  ...
	  <%
		if (request.getSession().getAttribute("msg_reset") != null) {
		%>
			<!-- FOR RESET PASSWORD MESSAGE -->
		<p>${msg_reset}</p>
		<%
		session.removeAttribute("msg_reset"); }
	  ...
	  <%if (request.getSession().getAttribute("msg_reset")!=null){ %>
                    ...
                    <%}request.getSession().removeAttribute("msg_reset");  %>
                        ...
                        <div class="col-lg-8  col-md-8 second-box">
                            ...
                            <form action="<%=request.getContextPath() %>/Controller_Login" method="post">
                                ...
                                <div class="input-group mb-3 icon col-lg-12">
                                    ...
                                    <input type="text" name="user" class="form-control" placeholder="Username" id="username" onkeyup="validateUname()">

                                </div>
									<div class="input-control">
                                    <div id="user-error" class="login-error"></div>
                                </div>	
	
                                <div  class="input-group mb-3 icon col-lg-12">
                                    <span class="input-group-text"><i class="fa-solid fa-lock"></i></span>
                                    <input type="password" name="pass" class="form-control" placeholder="Password" id="password" onkeyup="validateLoginPass()">

                                </div>
                                    <div class="input-control">
                                    <div id="pass-error" class="login-error"></div>
                               		</div>
                                ...
                                <div class="mt-5">
                               	<div class="input-control">
                                    ...
                                    <button class="btn btn-primary w-25 d-block ms-auto" type="submit" onclick="return validateLoginForm()">Login</button>
