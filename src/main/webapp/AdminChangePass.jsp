            ...
            <div class="row min-vh-100 flex-column flex-md-row">
                ...
                <div class="col-md-10 col-lg-10 main-content">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12 col-lg-5 changepass-img">

                            <img src="img/undraw_Task_re_wi3v.webp" alt="" class="img-fluid d-block mx-auto">


                        </div>
                        <div class="col-md-12 col-lg-5 changepass-content">

                            <h5>Change Password</h5>

                            <form action="<%=request.getContextPath() %>/Controller_AdminChangePass" method="post">
